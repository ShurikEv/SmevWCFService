...
{
    public sealed class SMEVMessageEncodingBindingElement : MessageEncodingBindingElement, IWsdlExportExtension
    {
        ...
        public SMEVMessageEncodingBindingElement(string logPath, string sender)
        ...
        public SMEVMessageEncodingBindingElement(string logPath)
            : this(new TextMessageEncodingBindingElement())
        {
            LogPath = logPath;
        }
        ...
        {
            return new SMEVTextMessageEncoderFactory("text/xml", "utf-8", _vers, _innerBindingElement.CreateMessageEncoderFactory(), LogPath, SenderActor);
        }

        public override BindingElement Clone()
        {
            return new SMEVMessageEncodingBindingElement(_innerBindingElement)
            {
